  ...
  try {
    ...
    if (typeof resultFabric.results !== undefined) {
      ...
      if (resultFabric.results.length > 0) {
        ...
        var Link = process.env.ROOT_END_POINT + "/dispositions?perPage=" + responseLimit +
          "&nextPageToken=" + next;
...
exports.dispositionsEvent = (req, res) => {
  ...
  if (req.query.EQ_disposition) {
    return responseUtil.response400(res, "EQ_disposition should not be included in the query parameters");
  }
